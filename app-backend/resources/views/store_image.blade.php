  ...
  <h3 align="center">Insert Image into Mysql Database in Laravel 6</h3>
    ...
    <div class="panel panel-default">
         ...
         <div class="form-group">
          <div class="row">
           <label class="col-md-4" align="right">Enter email</label>
           <div class="col-md-8">
         ...
         <div class="form-group">
          <div class="row">
           <label class="col-md-4" align="right">Enter password</label>
           <div class="col-md-8">
         ...
         <div class="form-group">
          <div class="row">
           <label class="col-md-4" align="right">Enter domain</label>
           <div class="col-md-8">
            <input type="text" name="user_domains" class="form-control" />
           </div>
          </div>
         </div>
     ...
     <div class="panel panel-default">
         ...
         <div class="table-responsive">
                <table class="table table-bordered table-striped">
                  ...
                  <tr>
                   <td>
                    <img src="store_image/fetch_image/"  class="img-thumbnail" width="75" />
                   </td>
                  </tr>
              </table>
              {!! $data->links() !!}
